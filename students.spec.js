const findBestStudent = require("./students.cjs");

test("Поиск имени студента с максимальным количеством баллов", () => {
  const studArray = [
    [
  ...
  const result = findBestStudent(studArray);

  expect(result).toEqual(["Ivan", "Stepan"]);
});

test("Поиск имени студента с максимальным количеством баллов, новые тестовые данные", () => {
  const studArray = [
    [
      { name: "Ivan", score: 0, date: "2022-10-11" },
      { name: "Maria", score: 5, date: "2022-10-10" },
      { name: "Olga", score: 100, date: "" },
      { name: "Stepan", score: 35, date: "2022-10-12" },
      { name: "Oleg", score: 9, date: "2022-10-01" },
      { name: "Zanna", score: 15, date: "2022-10-11" },
    ],
